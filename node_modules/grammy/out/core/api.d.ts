import { type BotCommand, type ChatPermissions, type InlineQueryResult, type InputFile, type InputMedia, type InputMediaAudio, type InputMediaDocument, type InputMediaPhoto, type InputMediaVideo, type InputSticker, type LabeledPrice, type MaskPosition, type PassportElementError } from "../types.js";
...
export declare class Api<R extends RawApi = RawApi> {
     ...
     */
    uploadStickerFile(user_id: number, sticker_format: "static" | "animated" | "video", sticker: InputFile, signal?: AbortSignal): Promise<import("@grammyjs/types/manage.js").File>;
    /**
